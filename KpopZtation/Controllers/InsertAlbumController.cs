...
namespace KpopZtation.Controllers
{
    public class InsertAlbumController
    {
        ...
        public static string insertAlbum(int artistId, string name, string desc, string price, string stock, string img, string extension, float size)
        {
            ...
            if (info.Equals(""))
            {
                info = AlbumHandler.insertAlbum(artistId, name, desc, price, stock, img);
            }
            return info;
        }
    }
